...
const DeleteSpeakerAcc = ({ isOpen, onClose }) => {
    ...
    const handleDeleteAccount = async () => {
        try {
            const response = await axios.delete('/api/delete/speaker-account', { data: { password } }, { withCredentials: true });
...
export default DeleteSpeakerAcc;