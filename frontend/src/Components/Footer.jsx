...
const Footer = () => {
  return (
    <footer className="bg-blue-950 text-blue-400 w-full px-12 montserrat text-sm pt-16 pb-8 poppins">
      <div className="flex justify-between items-start gap-10">
        <div className='flex flex-col w-[32vw]'>
          <h3 className="text-4xl font-semibold mb-4 moonDance">ConferenceHub</h3>
        ...
        <div className='flex flex-col w-1/4 justify-center items-center'>
          <h3 className="text-4xl font-semibold mb-4 moonDance">Quick Links</h3>
        ...
        <div className='flex flex-col w-[26vw]'>
          <h3 className="text-4xl font-semibold mb-4 moonDance">Contact Us</h3>
        ...
        <div className='flex flex-col w-1/4'>
          <h3 className="text-4xl font-semibold mb-4 moonDance">Stay Updated</h3>
          <form className="flex">
            <input
              type="email"
            ...
            <button
              type="submit"
              className="bg-blue-600 text-white px-4 py-2 rounded-r cursor-pointer hover:bg-blue-700 transition duration-300"
            >
              Subscribe
            </button>
          </form>
