...
const DeleteOrganiserAcc = ({ isOpen, onClose }) => {
    ...
    const handleDeleteAccount = async () => {
        try {
            const response = await axios.delete('/api/delete/organiser-account', { data: { password } }, { withCredentials: true });
...
export default DeleteOrganiserAcc;