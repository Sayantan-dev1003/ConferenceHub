          ...
          <div className='w-1/3'>
            <div className='w-full rounded-xl bg-white shadow-md self-start h-auto mb-6'>
              <div className='w-full p-6 border-b border-b-gray-300 space-y-5'>
                ...
                <button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:scale-105 transition-transform duration-300 shadow-lg text-white text-base px-[6.6rem] py-2 rounded-lg font-medium cursor-pointer" onClick={() => navigate(`/register-attendee/${conference._id}`)}>Register</button>
              </div>
