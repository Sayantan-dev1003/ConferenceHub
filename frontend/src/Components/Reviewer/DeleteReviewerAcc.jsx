...
const DeleteReviewerAcc = ({ isOpen, onClose }) => {
    ...
    const handleDeleteAccount = async () => {
        try {
            const response = await axios.delete('/api/delete/reviewer-account', { data: { password } }, { withCredentials: true });
...
export default DeleteReviewerAcc;